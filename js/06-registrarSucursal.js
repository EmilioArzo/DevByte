    ...
    document.getElementById('dataForm').addEventListener('submit', function(event) {
        ...
        if (imagenFile) {
            ...
            reader.onload = function(event) {
                ...
                saveToLocalStorage(id, horario, nombre, direccion, latitud, longitud, url, imagenUrl);
...
// Función para guardar sucursal en localStorage
function saveToLocalStorage(id, horario, nombre, direccion, latitud, longitud, url, imagenUrl) {
    const sucursal = {
        id: id.toString(),
        horario: horario,
        nombre: nombre,
